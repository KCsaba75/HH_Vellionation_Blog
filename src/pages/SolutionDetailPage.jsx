    ...
    <>
      ...
      <div className="py-12">
        <div className="container mx-auto px-4 max-w-6xl">
          <Button variant="ghost" onClick={() => navigate('/solutions')} className="mb-6">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="grid md:grid-cols-2 gap-12">
            <div className="aspect-square bg-secondary/50 rounded-xl overflow-hidden">
               <img alt={solution.name} className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1559223669-e0065fa7f142" />
            </div>
            ...
            <div>
              ...
              <div className="bg-primary/5 p-6 rounded-xl mb-8"><p className="text-sm text-muted-foreground mb-4">This is an affiliate solution. When you purchase or sign up through our link, you support Vellio Nation at no extra cost to you.</p></div>
              
              <div className="flex gap-4">
                <Button size="lg" className="w-full" asChild>
                  <a href={solution.affiliate_url || '#'} target="_blank" rel="noopener noreferrer">Get This Solution <ExternalLink className="ml-2 h-5 w-5" /></a>
                </Button>
                <DropdownMenu>
